...
suite(
  function (env) {
    describe("Surety requests", function () {
      let driver;
      ...
      it("opened surety requests page correctly", async function () {
        ...
        const openAccountMenu = await driver.findElement(
          By.id("surety_requests")
        );
        await openAccountMenu.click();

        await driver.sleep(2000);
        const openAccountUrl =
          (await process.env.REACT_APP_BASE_URL) + "surety/surety_requests";
