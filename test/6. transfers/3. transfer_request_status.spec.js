...
suite(
  function (env) {
    describe("Transfer Request Status", function () {
      let driver;
      ...
      it("opened transfer request status page correctly", async function () {
        ...
        const openAccountUrl =
          (await process.env.REACT_APP_BASE_URL) +
          "transfer/transfer_Request_Status";
